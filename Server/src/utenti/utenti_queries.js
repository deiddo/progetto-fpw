// Recupero utente/i
const getListaUtenti = "SELECT username FROM utenti ORDER BY username";
const getUtenteByUsername = "SELECT * FROM utenti WHERE username = $1 ORDER BY username";

// Aggiunta utente
const addUtente = "INSERT INTO utenti (username, password, nome, cognome, email, citta, eta, sesso) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)";
